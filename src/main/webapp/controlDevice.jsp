<%@ page import="org.core.device.config.HardwareSystemOptions" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<html>
<head>
    <title>Консоль управления <% out.print(HardwareSystemOptions.HW_CONCOLE_VERSION); %></title>
    ...
    <script src="js/videoRecordsPanel.js"></script>
                    ...
                    <td>
                        <div id="toolContainer" style="width: 482px; height: 213px; background-color: burlywood">
                            <div id="toolPanel" style="height: 20px; border: 1px solid black;">
                                ...
                                <button id="CP_ShowOpenCvSettingsButton" style="margin: 2px">Комп. зрен.</button>
                                <button id="CP_ShowRearCameraContainerButton" style="margin: 2px">Зад. кам.</button>
                                <button id="CP_ShowVideoRecordsButton" style="margin: 2px">Записи</button>
                            </div>
                                ...
                                <div style="height: 185px; overflow-y: scroll; overflow-x: hidden; border-right: 1px solid black; border-left: 1px solid black; border-bottom: 1px solid black">
                                    <table class="systemSettings" style="width: 100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr class="systemSettingsRow">
                                            ...
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_mainCameraQuality" type="text"
                                        ...
                                        <tr class="systemSettingsRow">
                                            ...
                                            <td class="systemSettingsValue">
                                                <select id="CP_Value_observeCameraResolution"
                                                        class="systemSettingsInput">
                                                    <option value="80x60">80 X 60</option>
                                                    <option value="160x120">160 X 120</option>
                                                    <option value="320x240">320 X 240</option>
                                        ...
                                        <tr class="systemSettingsRow">
                                            ...
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_observeCameraQuality" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="systemSettingsRow">
                                            ...
                                            <td class="systemSettingsValue">
                                                <select id="CP_Value_rearCameraIndex" class="systemSettingsInput">
                                                    <option value="video0">video0</option>
                                                    <option value="video1">video1</option>
                                                    <option value="video2">video2</option>
                                                    <option value="video3">video3</option>
                                        ...
                                        <tr class="systemSettingsRow">
                                            ...
                                            <td class="systemSettingsValue">
                                                <select id="CP_Value_rearCameraResolution" class="systemSettingsInput">
                                                    <option value="80x60">80 X 60</option>
                                                    <option value="160x120">160 X 120</option>
                                                    <option value="320x240">320 X 240</option>
                                                    <option value="640x480">640 X 480</option>
                                        ...
                                        <tr class="systemSettingsRow">
                                            ...
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_rearCameraQuality" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="systemSettingsLabel">
                                                Блок. при потере фокуса
                                            </td>
                                            <td class="systemSettingsValue">
                                                <select id="CP_lockDriveOnLostFocus" class="systemSettingsInput">
                                        ...
                                        <tr>
                                            <td class="systemSettingsLabel">
                                                не остан. при потере фокуса
                                            </td>
                                            <td class="systemSettingsValue">
                                                <select id="CP_dontStopDriveOnLostFocus" class="systemSettingsInput">
                                                    <option value="true">Да</option>
                                                    <option value="false">Нет</option>
                                                </select>
                                            </td>
                                        ...
                                        <tr class="systemSettingsRow">
                                            ...
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_vpsServerIp" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr class="systemSettingsRow">
                                        ...
                                        <tr>
                                            <td class="systemSettingsLabel">
                                                Доля ускоряющейся стороны при повороте
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_engineRotateBalance" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="systemSettingsLabel">
                                                чувствительность руля (коэф.)
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_engineRotateScaler" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="systemSettingsH2">
                                                Нелинейность руля
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="systemSettingsLabel">
                                                Макс. коэф. нелинейности (1 вык)
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_engineRotateCorrMaxCoef" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="systemSettingsLabel">
                                                Нелинейность до скорости (0 вык)
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_engineRotateCorrCutOffSpeed" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="systemSettingsLabel">
                                                Считать эксспоненту от (-2 стд)
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_engineRotateCorrExpFrom" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="systemSettingsLabel">
                                                Считать эксспоненту по (3 стд)
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_engineRotateCorrExpTo" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="systemSettingsLabel">
                                                Длит.имп. сдергивания с места (мс)
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_enginePullofDelay" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_engineBalance" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_enginesDownshift" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_enginesUpshift" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="systemSettingsLabel">
                                                Мощность передатчика доп. WiFi (dBm)
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_systemConnectionWifiExternalPowerDbi" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="systemSettingsLabel">
                                                Автостарт доп WiFi в режиме точки доступа
                                            </td>
                                            <td class="systemSettingsValue">
                                                <select id="CP_Value_systemConnectionWifiExternalAutostart"
                                                        class="systemSettingsInput">
                                                    <option value="true">Да</option>
                                                    <option value="false">Нет</option>
                                                </select>
                            ...
                            <div id="openCvSettingsContainer" style="width: 482px; height: 232px; display: none">
                                <div style="height: 22px;background-color: #B48E6B; width: 480px; border: 1px solid black;"
                                     align="center">Настройки
                                </div>
                                <div style="height: 185px; overflow-y: scroll; overflow-x: hidden; border-right: 1px solid black; border-left: 1px solid black; border-bottom: 1px solid black">
                                    <table class="systemSettings" style="width: 100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr class="systemSettingsRow">
                                            <td class="systemSettingsLabel">
                                                Захват видео разрешен
                                            </td>
                                            <td class="systemSettingsValue">
                                                <select id="CP_Value_openCvCameraEnabled"
                                                        class="systemSettingsInput">
                                                    <option value="true">Да</option>
                                                    <option value="false">Нет</option>
                                                </select>
                                        ...
                                        <tr class="systemSettingsRow">
                                            ...
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_openCvCameraFrameRate" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr class="systemSettingsRow">
                                            ...
                                            <td class="systemSettingsValue">
                                                <select id="CP_Value_openCvSystemCameraIndex"
                                                        class="systemSettingsInput">
                                                    <option value="0">главная экран(ходовая)</option>
                                                    <option value="1">малый экран</option>
                                                    <option value="2">экран заднего вида</option>
                                                </select>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="systemSettingsRow">
                                            ...
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_openCvVideoRecorderFilePath" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr class="systemSettingsRow">
                                            <td class="systemSettingsLabel">
                                                Кодек видео (4 символа)
                                            </td>
                                            <td class="systemSettingsValue">
                                                <select id="CP_Value_openCvVideoRecorderFileFormat"
                                                        class="systemSettingsInput">
                                                    <option value="H264">h.264</option>
                                                    <option value="XVID">xVid</option>
                                                    <option value="PIM1">MPEG-1</option>
                                                    <option value="MJPG">MJpeg</option>
                                                    <option value="DIV4">DivX MPEG-4</option>
                                                    <option value="DX50">DivX MPEG-4 (v5)</option>
                                                    <option value="FFV1">FFMPEG Codec(loosles)</option>
                                                    <option value="HFYU">Huffman Lossless Codec</option>
                                                </select>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="2" class="systemSettingsH1">
                                                Web трансляция видео
                                            </td>
                                        </tr>
                                        <tr class="systemSettingsRow">
                                            <td class="systemSettingsLabel">
                                                Степень сжатия кадров
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_openCvWebStreamerQuality" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr class="systemSettingsRow">
                                            ...
                                            <td class="systemSettingsValue">
                                                <select id="CP_Value_openCvWebStreamerMaxResolution" class="systemSettingsInput">
                                                    <option value="80x60">80 X 60</option>
                                                    <option value="160x120">160 X 120</option>
                                                    <option value="320x240">320 X 240</option>
                                                    <option value="640x480">640 X 480</option>
                                        ...
                                        <tr>
                                            ...
                                            <td class="systemSettingsValue">
                                                <select id="CP_Value_openCvMoveDetectorAutostart"
                                                        class="systemSettingsInput">
                                                    <option value="true">Да</option>
                                                    <option value="false">Нет</option>
                                                </select>
                                        ...
                                        <tr class="systemSettingsRow">
                                            <td class="systemSettingsLabel">
                                                нижний уровень ЧБ фильтра 1
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_openCvMoveDetectorThreshold1DownLevel" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr class="systemSettingsRow">
                                            <td class="systemSettingsLabel">
                                                Размер блока для размытия
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_openCvMoveDetectorBlurSpotSize" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr class="systemSettingsRow">
                                            <td class="systemSettingsLabel">
                                                нижний уровень ЧБ фильтра 2
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_openCvMoveDetectorThreshold2DownLevel" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr class="systemSettingsRow">
                                            <td class="systemSettingsLabel">
                                                Минимальная ширина для объекта
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_openCvMoveDetectorMinRegionWidth" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                        <tr class="systemSettingsRow">
                                            <td class="systemSettingsLabel">
                                                Минимальная высота для объекта
                                            </td>
                                            <td class="systemSettingsValue">
                                                <input id="CP_Value_openCvMoveDetectorMinRegionHeight" type="text"
                                                       class="systemSettingsInput">
                                            </td>
                                        </tr>
                                ...
                                <div style="height: 30px; background-color: #B48E6B" align="right">
                                    <button id="CP_SaveOpenCvSettingsButton" style="margin: 5px">Сохранить</button>
                                    <button id="CP_CancelOpenCvSettingsButton" style="margin: 5px">Отмена</button>
                                </div>
                            </div>

                            <div id="recordsPanelContainer" style="width: 482px; height: 232px; display: none">
                                <div style="height: 22px;background-color: #B48E6B; width: 480px; border: 1px solid black;"
                                     align="center">Видеозаписи
                                </div>
                                <div id="recordsPanelTableContainer" style="height: 185px; overflow-y: scroll; overflow-x: hidden; border-right: 1px solid black; border-left: 1px solid black; border-bottom: 1px solid black">
                                </div>
                                <div style="height: 30px; background-color: #B48E6B" align="right">
                                    <button id="CP_CloseVideoRecordsButton" style="margin: 5px">Закрыть</button>
                                </div>
                            </div>

                            <div id="rearCameraContainer" style="width: 482px; height: 216px; display: none">
                                <div id="rearCameraDiv"
                                     style="width: 288px; height: 216px; border-style: solid; border-color: yellow; border-width: 1px"/>
                            </div>
                    ...
                    <td colspan="4">
                        ...
                        <table style="background-color: burlywood; border-collapse: collapse; font-size: 10px"
                            ...
                            <tr>
                                ...
                                <td id="sysParamValue_FROM_LAST_CHARGE" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>

                                <td class="sysParamLabel">
                                    Tc driver
                                </td>
                                <td id="sysParamValue_DRIVERT_TEMPR" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>

                                <td class="sysParamLabel">
                                    X axis
                                </td>
                                <td id="sysParamValue_MAG_X_VALUE" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>
                            </tr>
                            <tr>
                                <td class="sysParamLabel">
                                ...
                                <td id="sysParamValue_MAIN_VOLTAGE" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>

                                <td class="sysParamLabel">
                                    left drv voltage
                                </td>
                                <td id="sysParamValue_LEFT_DRIVER_VOLTAGE" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>

                                <td class="sysParamLabel">
                                    Y axis
                                </td>
                                <td id="sysParamValue_MAG_Y_VALUE" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>
                            ...
                            <tr>
                                ...
                                <td id="sysParamValue_MAINBOARD_CURRENT" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>

                                <td class="sysParamLabel">
                                    total current
                                </td>
                                <td id="sysParamValue_MAIN_CURRENT" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>

                                <td class="sysParamLabel">
                                    right drv voltage
                                </td>
                                <td id="sysParamValue_RIGHT_DRIVER_VOLTAGE" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>

                                <td class="sysParamLabel">
                                    kren-gen
                                </td>
                                <td id="sysParamValue_ACCL_KRENGEN_VALUE" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>
                            ...
                            <tr>
                                ...
                                <td id="sysParamValue_TOTAL_CONSUMED" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>

                                <td class="sysParamLabel">
                                    Z axis
                                </td>
                                <td id="sysParamValue_MAG_Z_VALUE" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>

                                <td class="sysParamLabel">
                                    tangage
                                </td>
                                <td id="sysParamValue_ACCL_TANGAGE_VALUE" class="sysParamValue"></td>
                                <td style="width: 30px; background-color: #D4AE7E"></td>
                            </tr>
                        </table>
                ...
                <tr>
                    ...
                    <td class="camControlButtonCell" id="camControlCell2">
                        <button id="showVideo2" class="camControlButton"
                            ...
                            <img src="img/webcam.png" style="vertical-align: middle" title="Камера обзорная">
                        </button>
                    </td>
                    ...
                    <td class="camControlButtonCell" id="videoRecorderCell">
                        <button id="videoRecorder" class="camControlButton"
                                onclick="onOffVideoRecorder(this, 'videoRecorderCell')">
                            <img src="img/camcorder.png" style="vertical-align: middle" title="Запись с активной камеры машинного зрения">
                        </button>
                    </td>
                    ...
                    <td class="camControlButtonCell" id="logoutCell">
                        <button id="LogoutButton" class="camControlButton"
                                onclick="window.location = location.protocol + '//' + location.hostname + ':' + location.port + '/tank/logout'">
