 ...
 */
public class ImageMultiThreadWebStreamer implements ImageStreamer, Runnable {

    private static final Logger LOG = LoggerFactory.getLogger(ImageMultiThreadWebStreamer.class);
    ...
    public ImageMultiThreadWebStreamer(int port, int quality, Size videoSize) {
        this.port = port;
